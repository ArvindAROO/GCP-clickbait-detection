        ...
        if index[i] == {}:
            ...
            for j in index:
                if i == j or j == {}:
                    ...
                    # print(i, j)
                    if ".txt" not in i or ".txt" not in j:
                        pass
                    else:
                        sim = similarity(index[i], index[j])
                        if sim != 0:
                            print(i, j, sim)
...
if __name__ == "__main__":
    # print(classify("I am very happy today. I am very happy today. I am very happy today. I am very happy today. I am very happy today. I am very happy today. "))
    # print(index(".", "categories.json"))
    # print(query_category("categories.json", "/Science/Computer Science", n_top=3))
